                        ...
                        <PopoverBody  p={0} m={0}  >
                            <ul  className=" grid  grid-cols-1  items-left menu shadow bg-white  ">
                                ...
                                <li onClick={() => {
                                    ...
                                    setTypeFilters(false)
                                    filterFunction(2)
                                }}><a className={typeFilter2 ? "w-full flex items-center justify-start " :"w-full flex items-center justify-start  hover:underline"}><div className={typeFilter2 ? "rounded-[90px] p-1 border border-[#000] border-2 bg-[#FF8932]" :"rounded-[90px] p-1 border border-[#000] border-2"}></div>Суши</a></li>
                                <li onClick={() => {
                                    setTypeFilter3(!typeFilter3)
                                    setTypeFilters(false)
                                    filterFunction(3)
                                }}><a className={typeFilter3 ? "w-full flex items-center justify-start " :"w-full flex items-center justify-start  hover:underline"}><div className={typeFilter3 ? "rounded-[90px] p-1 border border-[#000] border-2 bg-[#FF8932]" :"rounded-[90px] p-1 border border-[#000] border-2"}></div>Роллы</a></li>
                                <li onClick={() => {
                                    setTypeFilter4(!typeFilter4)
                                    setTypeFilters(false)
                                    filterFunction(4)
                                }}><a className={typeFilter4 ? "w-full flex items-center justify-start " :"w-full flex items-center justify-start  hover:underline"}><div className={typeFilter4 ? "rounded-[90px] p-1 border border-[#000] border-2 bg-[#FF8932]" :"rounded-[90px] p-1 border border-[#000] border-2"}></div>Горячие роллы</a></li>
                                <li onClick={() => {
                                    setTypeFilter5(!typeFilter5)
                                    setTypeFilters(false)
                                    filterFunction(5)
                                }}><a className={typeFilter5 ? "w-full flex items-center justify-start " :"w-full flex items-center justify-start  hover:underline"}><div className={typeFilter5 ? "rounded-[90px] p-1 border border-[#000] border-2 bg-[#FF8932]" :"rounded-[90px] p-1 border border-[#000] border-2"}></div>Сеты</a></li>
